...
import { CauldronV4 } from "../src/CauldronV4.sol";
...
import { CauldronFactory } from "../src/CauldronFactory.sol";
...
contract ScalarSystemDeployScript is BaseScript {
    ...
    function deployDegenBoxAndMasterCauldron() internal {
        ...
        masterCauldron = new CauldronV4(IBentoBoxV1(address(degenBox)), IERC20(address(stableCoin)));
