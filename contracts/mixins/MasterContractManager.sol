...
contract MasterContractManager is BoringOwnable, BoringFactory {
    ...
    event LogSetMasterContractOf(address indexed market, address indexed masterContract);
    ...
    function setMasterContractOf(address market, address masterContract) public {
        masterContractOf[market] = masterContract;
        emit LogSetMasterContractOf(market, masterContract);
    }
